        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            ...
            <form onSubmit={handleSubscribe} className="flex">
              ...
              <button
                type="submit"
                className="bg-white text-gray-900 px-6 py-3 text-xs tracking-[0.15em] uppercase font-medium hover:bg-gray-100 transition-colors border-l border-gray-200"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
            <p>
              Copyright © {new Date().getFullYear()} DigiFist. All rights reserved.
              Powered by Shopify.
            </p>
