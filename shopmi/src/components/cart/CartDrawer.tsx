    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-grow overflow-y-auto p-3 sm:p-4 overscroll-contain"> 
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-500 px-4">
            ...
            <SheetClose asChild>
              <Button className="mt-4 sm:mt-6 min-h-[44px] px-6 py-3 bg-[#AE6FFB] text-white rounded-md hover:bg-[#E05A00] transition-colors text-sm sm:text-base font-medium">
                Continuar Comprando
              </Button>
            </SheetClose>
          </div>
      ...
      {cart.length > 0 && (
        <div className="border-t p-3 sm:p-4 bg-gray-50 safe-area-inset-bottom">
          ...
          {selectedShipping && (
            <div className="flex justify-between mb-2 text-sm sm:text-base font-semibold text-[#AE6FFB]">
              <span>Total:</span>
          ...
          <button 
            ...
            className="w-full min-h-[48px] py-3 sm:py-3.5 bg-[#AE6FFB] text-white rounded-md hover:bg-[#E05A00] transition-colors font-medium text-sm sm:text-base active:scale-[0.98]"
          >
            Finalizar Compra
          </button>
