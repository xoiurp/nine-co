    ...
    >
      ...
      <div className="relative">
        ...
        <div className="absolute top-2 left-2 right-2 z-10 flex justify-between items-start pointer-events-none">
          <div className="flex flex-col gap-1">
            ...
            {isNew && (
              <span className="bg-white text-[#AE6FFB] text-[10px] font-semibold px-2 py-1 rounded-full border border-[#AE6FFB]">
                Lançamento
              </span>
            )}
          </div>
      ...
      <div className="p-3 flex flex-col bg-white">
        <Link href={`/product/${handle}`} className="block">
          {/* Título do produto */}
          <h3 className="text-sm font-semibold text-gray-900 mb-1.5 hover:text-[#AE6FFB] transition-colors line-clamp-2 leading-tight">
            {title}
          </h3>
        </Link>
        ...
        <div className="pt-1">
          ...
          <div className="text-lg font-bold text-[#AE6FFB]">
        ...
        <button
          ...
          className={`w-full py-2.5 px-4 rounded-full text-sm font-medium transition-all
            ${!availableForSale || totalStock === 0 
              ...
              : 'bg-[#AE6FFB] text-white hover:bg-[#e55a00] active:scale-[0.98]'
            }`}
        >
