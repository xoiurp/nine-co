...
const IsolatedHtmlContentTest: React.FC<IsolatedHtmlContentProps> = ({
  ...
  }, [htmlContent, mobileHtmlContent, isMobile, mobileFooterHeight, desktopFooterHeight, preserveOriginalStyles, iframeRef, contentToUse, fontSizeMetafield, mobileFontSizeMetafield]);
