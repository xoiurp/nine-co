    ...
    <Accordion type="multiple" defaultValue={['categories', 'price', 'tags', 'product_types']} className="w-full">
                ...
                <Link
                  ...
                  className={`block py-1 transition-colors ${
                    collection.handle === currentCategoryHandle
                      ? 'text-[#AE6FFB] font-medium'
                      : 'text-gray-600 hover:text-[#AE6FFB]'
                  }`}
                >
                  {collection.title}
                </Link>
              ...
              <>
                ...
                {currentTagsList.length > 7 && (
                  <Button
                    ...
                    className="text-sm text-[#AE6FFB] hover:text-[#E05A00] p-0 h-auto mt-2"
                  >
      ...
      <div className="mt-6">
        <Button
          ...
          className="w-full text-sm text-gray-600 hover:text-[#AE6FFB] hover:bg-[#AE6FFB]/10" // Cor de hover alterada
        >
