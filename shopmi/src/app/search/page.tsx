    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="flex items-center text-sm text-gray-500">
          <Link href="/" className="hover:text-[#AE6FFB]" aria-label="Início"> {/* Adicionado aria-label */}
      ...
      <div className="mb-8">
        <form onSubmit={handleSubmit} className="flex w-full max-w-3xl mx-auto">
          <input
            ...
            className="flex-grow py-3 px-4 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-[#AE6FFB] focus:border-transparent"
          />
          <button
            type="submit"
            className="bg-[#AE6FFB] text-white py-3 px-6 rounded-r-md hover:bg-[#E05A00] transition-colors"
          >
            Buscar
          </button>
        </form>
      ...
      <div>
        {loading ? (
          <div className="text-center py-12">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#AE6FFB]"></div>
          ...
          <>
            ...
            {products.length > 0 && pageInfo ? (
              ...
              <div className="text-center py-12">
                ...
                <Link
                  href="/shop"
                  className="bg-[#AE6FFB] text-white py-2 px-6 rounded-md hover:bg-[#E05A00] transition-colors inline-block"
                >
...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="text-center py-12"><div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#AE6FFB]"></div><p className="mt-4 text-gray-600">Carregando busca...</p></div>}>
      <SearchPageContent />
    </Suspense>
  );
}
