    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
      ...
      <div className="mb-4 sm:mb-6 md:mb-8">
        ...
        <div className="flex items-center text-xs sm:text-sm text-gray-500">
          <Link href="/" className="hover:text-[#AE6FFB] min-h-[44px] min-w-[44px] flex items-center justify-center -ml-2" aria-label="Início">
            <HomeIcon className="h-4 w-4" />
          </Link>
          <span className="mx-1 sm:mx-2">/</span>
          <Link href="/shop" className="hover:text-[#AE6FFB]">
            Loja
          </Link>
          <span className="mx-1 sm:mx-2">/</span>
        ...
        <div className="flex-grow min-w-0">
          ...
          {initialProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <Link
                href="/shop"
                className="mt-4 inline-block text-[#AE6FFB] hover:underline"
              >
