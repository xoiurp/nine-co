...
export const metadata = {
  title: "Termos e Condições - Ninē & CO",
  description:
    "Leia os termos e condições de uso da loja Ninē & CO antes de realizar suas compras.",
};
    ...
    items: [
      {
        ...
        answer:
          "Estes Termos e Condições regulam o uso do site e dos serviços oferecidos pela Ninē & CO. Ao acessar e utilizar nosso site, você declara que leu, compreendeu e concorda com todos os termos aqui descritos. Caso não concorde com algum dos termos, solicitamos que não utilize nossos serviços.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Se o produto apresentar defeito de fabricação, você tem até 90 dias para solicitar a troca ou reparo. Entre em contato com nosso suporte enviando fotos do defeito e o número do pedido. A Ninē & CO arcará com todos os custos de envio para devolução de produtos defeituosos.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        question: "Quais são as limitações de responsabilidade da Ninē & CO?",
        answer:
          "A Ninē & CO se esforça para manter o site disponível e funcionando corretamente, mas não garante que o acesso será ininterrupto ou livre de erros. Não nos responsabilizamos por danos indiretos, incidentais ou consequentes decorrentes do uso ou impossibilidade de uso do site, exceto nos casos previstos em lei.",
      },
      {
        question: "Como funciona a propriedade intelectual?",
        answer:
          "Todo o conteúdo do site, incluindo textos, imagens, logotipos, designs, fotografias e software, é propriedade da Ninē & CO ou de seus licenciantes e está protegido pelas leis brasileiras de propriedade intelectual. É proibida a reprodução, distribuição ou modificação de qualquer conteúdo sem autorização prévia por escrito.",
      },
      {
      ...
      <section className="relative w-full bg-[#f5f5f5] pt-[120px] md:pt-[140px] pb-12 md:pb-16">
        <div className="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-[#666] max-w-2xl mx-auto leading-relaxed font-light">
            ...
            e a realização de compras na Ninē & CO.
          </p>
        </div>
      </section>
